...
| | measured | evidence |
|---|---|---|
| **Full task, scripted expert** (drawer → fork → spoon handed A→B → plate → hold + pour → mug) | **7/10** held-out seeds · 8/10 train | `results/seeds_expert_*` |
...
| **Target-volume pour** ("a little" / normal / "fill it up" → 3 / 6 / 12 water spheres; the roll stops when the oracle counts the target) | little (target 3): mean 4.0 spheres, within ±2 in **4/5**, reached 5/5 · normal (target 6): mean 6.0 spheres, within ±2 in **5/5**, reached 5/5 · full (target 12): mean 12.0 spheres, within ±2 in **5/5**, reached 5/5 | `results/pour_amount.json` |
