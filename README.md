...
| **Table-state anomaly check** (Anomalib PatchCore → OpenVINO IR, overhead camera, held-out layouts) | image AUROC **0.762** · exported threshold: 72/75 disturbances flagged, 38/60 false alarms · at 10% false alarms: 26/75 caught · IR p50 CPU 591.0 ms | `results/anomaly.json` |
