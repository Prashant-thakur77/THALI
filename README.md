...
| **Table-state anomaly check** (Anomalib PatchCore → OpenVINO IR, overhead camera, held-out layouts) | full frame (wide_resnet50): image AUROC **0.762** · exported threshold: 72/75 disturbances flagged, 38/60 false alarms · at 10% false alarms: 26/75 caught · IR p50 CPU 591.0 ms — table crop (resnet18): AUROC **0.78**, 42/60 false alarms, at 10% false alarms 31/75 caught, IR p50 CPU 75.75 ms | `results/anomaly.json` |
