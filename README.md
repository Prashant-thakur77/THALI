...
| **Per-skill SmolVLA, policy only** (multi-task, language-conditioned; Kaggle T4 fine-tune in 4 500-step sessions — the newest checkpoint of the 20 000-step run, re-evaluated as sessions land) | step 9500: open_drawer **12/20** · pick_place_fork **0/20** (median 30.9 cm from zone) · pick_place_plate **0/20** (median 18.71 cm from zone) · pick_place_mug **0/20** (median 24.47 cm from zone) · handoff_spoon **0/20** (median 39.45 cm from zone) · hold_mug **4/20** · pour **0/20** | `results/skill_eval_smolvla_*.json` |
