...
| Per-skill SmolVLA policy-only (step 5 000 of 20 000) | {{ skill_row("smolvla_5k") }} | `python -m eval.skill_eval --kind smolvla --smolvla-path <Prashant-77/thali_smolvla> --tag smolvla_5k` | `results/skill_eval_smolvla_5k.json` |
