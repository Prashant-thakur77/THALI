...
| Per-skill SmolVLA policy-only (newest checkpoint) | {{ smolvla_row() }} | `python -m eval.skill_eval --kind smolvla --smolvla-path <Prashant-77/thali_smolvla> --tag smolvla_5k` | `results/skill_eval_smolvla_5k.json` |
