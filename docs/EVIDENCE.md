...
| ACT policy-only, test | pending | `eval/run_seeds.py --policy act --mode policy_only` | results/seeds_act_policy_only_test.json |
| ACT + retry, test | pending | `eval/run_seeds.py --policy act --mode policy_retry` | results/seeds_act_policy_retry_test.json |
| ACT + retry + expert fallback, test | pending | `eval/run_seeds.py --policy act --mode policy_fallback` | results/seeds_act_policy_fallback_test.json |
...
| Camera vs oracle | pixels 78% | `eval/camera_vs_oracle.py` | results/camera_vs_oracle.json |
...
| OpenVINO latency | fp32/CPU 114.39 ms, fp32/GPU 555.63 ms, fp16/CPU 111.51 ms, fp16/GPU 556.94 ms, int8/CPU 36.95 ms, int8/GPU 421.94 ms | `bench/run.py` | results/bench.json / bench.md |
| Precision preservation | pending | `bench/preserve.py` | results/preserve.json |
