...
| OpenVINO / Core Ultra (20) | ACT → IR fp32/fp16 + NNCF int8, CPU + iGPU latency, 10-seed preservation per precision, VLM tok/s | `results/bench.json` (fp32/CPU 110.74 ms, fp32/GPU 554.85 ms, fp16/CPU 110.44 ms, fp16/GPU 554.92 ms, int8/CPU 36.76 ms, int8/GPU 415.62 ms), `results/preserve.json`, `results/ir_export.json`. **No NPU here**; static shapes ready for `-d NPU`. |
